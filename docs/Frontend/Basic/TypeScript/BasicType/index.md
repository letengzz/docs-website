...
![TypeScript 数据类型](../assets/img202401282332924.png)
...
```typescript [undefined-return.ts]
...
```javascript [enum-normal-compiled.js]
'use strict'
var Directions
;(function (Directions) {
...
```javascript [enum-const-compiled.js]
'use strict'
