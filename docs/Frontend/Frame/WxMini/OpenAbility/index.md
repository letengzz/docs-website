...
当小程序需要让用户完善个人资料时，可以通过微信提供的头像、昵称填写能力快速完善。
...
```html
<button  class="btn" open-type="chooseAvatar" bindchooseavatar="getAvatar">
...
官方文档：https://developers.weixin.qq.com/miniprogram/dev/reference/api/Page.html#onShareTimeline
...
![image-20250825203324631](assets/image-20250825203324631.png)
