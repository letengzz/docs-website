...
<img src="../assets/img202401310106357.gif" alt="3.gif" style="height:300px;border-radius:10px"  /><img src="../assets/img202401310122342.gif" alt="4.gif" style="height:300px;border-radius:10px"  />
...
1. `ref`创建的变量必须使用`.value`（可以使用vscode的`volar`插件自动添加`.value`：设置中勾选Auto Insert Dot Value）。
   ...
   <img src="../assets/img202401312120000.png" alt="自动补充value" style="zoom:50%;border-radius:20px" />
...
let fullName = computed({
  ...
  get() {
    return (
      ...
      firstName.value.split('-')[0].slice(1) +
      '-' +
      lastName.value
    )
  },
...
![image-20240207205914975](../assets/img202402091442507.png)
...
![image-20240207210941131](../assets/img202402091447197.png)
...
![image-20240207212000020](../assets/img202402091443449.png)
...
![image-20240207212544477](../assets/img202402091443856.png)
