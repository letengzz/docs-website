...
应用侧只需要盯住四个数：**召回命中率、引用正确率、拒答准确率、单次成本**。指标定义、评测集构建方法与回归脚本见 [RAG 检索增强 · 评估体系](../../RAG/Evaluation/index.md)。
...
接入跑通之后，常见的下一步优化都在下面这几页：

| 想解决的问题 | 阅读 |
| --- | --- |
| 换嵌入模型、调维度 | [嵌入与向量基础](../../RAG/Embedding/index.md) |
| 切分把语义切断了 | [文档解析与切分](../../RAG/Chunking/index.md) |
| 选向量库、调索引参数 | [向量库与索引](../../RAG/VectorStore/index.md) |
| 召回不准、排序靠后 | [检索优化](../../RAG/Retrieval/index.md) |
| 想量化效果、做回归 | [评估体系](../../RAG/Evaluation/index.md) |
| 权限、增量更新、缓存 | [生产工程化](../../RAG/Pipeline/index.md) |
