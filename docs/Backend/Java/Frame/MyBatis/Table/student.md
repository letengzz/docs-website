...
```sql
insert into student(s_name,age,sex) values ("小明",15,"男");
insert into student(s_name,age,sex) values ("小红",19,"女");
insert into student(s_name,age,sex) values ("小寸",25,"男");
```
...
个别操作可能不适合下列内容，仅作通用参考。

:::

### 整体结构

![image-20230202170525515](assets/202303011659794.png)
