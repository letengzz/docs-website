...
::: info 补充
Java 26 已于 2026-03-17 发布，是 Java 25 之后的**功能版本（非 LTS）**，支持期约 6 个月；生产环境仍以 Java 21 / 25 LTS 为主，Java 26 适合体验新特性。
:::
...
::: warning 说明
初学阶段只需要记住「Java 代码 → 字节码 → JVM 执行」这条主线；内存模型和垃圾回收放到后续 [JVM 基础](../JVM/index.md) 专题深入。
::: 
