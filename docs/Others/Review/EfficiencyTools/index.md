...
- [效率工具](../../../Tools/Efficiency/index.md)：本页清单的系统化版本——终端、命令行、剪贴板、截图、笔记、自动化六个环节的判断标准与落地步骤。
- [效率工具 · 概述与选型](../../../Tools/Efficiency/Overview/index.md)：五类工具地图与「回本周期」算法，用来决定先学哪个。
- [效率工具 · 常见问题与最佳实践](../../../Tools/Efficiency/FAQ/index.md)：15 条踩坑、12 条最佳实践与术语表。
- [IDE 配置](../../../Tools/IDE/index.md)：编辑器/IDE 是使用频率最高的工具，选型、插件、快捷键与配置同步都在这条线上。
- [IDE 配置 · 快捷键与高效操作](../../../Tools/IDE/Shortcuts/index.md)：「每周练熟 5 个」的可操作性清单与能力地图。
- [IDE 配置 · 插件与扩展](../../../Tools/IDE/Plugins/index.md)：装机清单与「装多了会变慢」的量化判据。
- [协作与项目管理](../../../Tools/Collaboration/index.md)：团队层面的工具链统一与流程自动化。
