        ...
        items: [
            { text: "前端开发", link: "/docs/Frontend/Basic/FrontendDevelop/index.md" },
            {
                text: "HTML", link: "/docs/Frontend/Basic/HTML/index.md", collapsed: true, items: [
                    ...
                    { text: "HTML 标签分类", link: "/docs/Frontend/Basic/HTML/Classify/index.md" },
                    { text: "HTML 全局属性", link: "/docs/Frontend/Basic/HTML/Global/index.md" },
                    { text: "HTML 排版标签", link: "/docs/Frontend/Basic/HTML/Compose/index.md" },
                    { text: "HTML 文本标签", link: "/docs/Frontend/Basic/HTML/Text/index.md" },
                    { text: "HTML 图片标签", link: "/docs/Frontend/Basic/HTML/Image/index.md" },
                    { text: "HTML 超链接标签", link: "/docs/Frontend/Basic/HTML/Hyperlink/index.md" },
                    { text: "HTML 视频标签", link: "/docs/Frontend/Basic/HTML/Video/index.md" },
                    { text: "HTML 音频标签", link: "/docs/Frontend/Basic/HTML/Audio/index.md" },
                    { text: "HTML 列表标签", link: "/docs/Frontend/Basic/HTML/List/index.md" },
                    { text: "HTML 表格标签", link: "/docs/Frontend/Basic/HTML/Table/index.md" },
                    { text: "HTML 表单标签", link: "/docs/Frontend/Basic/HTML/Form/index.md" },
                    { text: "HTML 框架标签", link: "/docs/Frontend/Basic/HTML/Iframe/index.md" },
                    { text: "HTML 实体标签", link: "/docs/Frontend/Basic/HTML/Entity/index.md" },
                    { text: "HTML meta元信息", link: "/docs/Frontend/Basic/HTML/meta/index.md" },
                    { text: "HTML 无语义标签", link: "/docs/Frontend/Basic/HTML/NoSemantic/index.md" },
                    { text: "HTML5 布局标签", link: "/docs/Frontend/Basic/HTML/Layout/index.md" },
                    { text: "HTML5 状态标签", link: "/docs/Frontend/Basic/HTML/Status/index.md" },
                    { text: "HTML5 兼容性处理", link: "/docs/Frontend/Basic/HTML/Compatibility/index.md" },
                ]
            },
            {
                text: "CSS", link: "/docs/Frontend/Basic/CSS/index.md", collapsed: true, items: [
                    ...
                    { text: "CSS 常用属性", link: "/docs/Frontend/Basic/CSS/Commons/index.md" },
                    { text: "CSS 长度单位", link: "/docs/Frontend/Basic/CSS/LengthUnit/index.md" },
                    { text: "CSS 元素的显示模式", link: "/docs/Frontend/Basic/CSS/DisplayMode/index.md" },
                    { text: "CSS 盒子模型", link: "/docs/Frontend/Basic/CSS/BoxModel/index.md" },
                    { text: "CSS 浮动", link: "/docs/Frontend/Basic/CSS/Float/index.md" },
                    { text: "CSS 定位", link: "/docs/Frontend/Basic/CSS/Position/index.md" },
                    ...
                    { text: "CSS 变量", link: "/docs/Frontend/Basic/CSS/Variable/index.md" },
                    {
                        text: "CSS3", collapsed: true, link: "/docs/Frontend/Basic/CSS/CSS3/index.md", items: [
                            ...
                            { text: "web字体", link: "/docs/Frontend/Basic/CSS/CSS3/webFont/index.md" },
                            { text: "2D变换", link: "/docs/Frontend/Basic/CSS/CSS3/2D/index.md" },
                            { text: "3D变换", link: "/docs/Frontend/Basic/CSS/CSS3/3D/index.md" },
                            { text: "过渡", link: "/docs/Frontend/Basic/CSS/CSS3/Transition/index.md" },
                            { text: "动画", link: "/docs/Frontend/Basic/CSS/CSS3/Animation/index.md" },
                            { text: "多列布局", link: "/docs/Frontend/Basic/CSS/CSS3/Column/index.md" },
                            { text: "伸缩盒模型", link: "/docs/Frontend/Basic/CSS/CSS3/Flex/index.md" },
                            { text: "响应式布局", link: "/docs/Frontend/Basic/CSS/CSS3/Media/index.md" },
                            { text: "BFC", link: "/docs/Frontend/Basic/CSS/CSS3/BFC/index.md" },
                        ]
                    },
                    {
            ...
            },
            {
                text: "jQuery", link: "/docs/Frontend/Basic/jQuery/index.md", collapsed: true, items: [
                    ...
                    { text: "jQuery 事件处理", link: "/docs/Frontend/Basic/jQuery/Event/index.md" },
