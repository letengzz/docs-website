    ...
    items: [
      {
        ...
        items: [
          ...
          { text: "集合框架", link: "/docs/Backend/Java/JavaSE/Collection/index.md" },
        ...
        items: [
          ...
          { text: "Spring MVC", link: "/docs/Backend/Java/Frame/SpringMVC/index.md" },
          {
            ...
            items: [
              ...
              {
                text: "Spring Boot 4.x（当前稳定版）",
                link: "/docs/Backend/Java/Frame/SpringBoot/v4/index.md",
                collapsed: false,
                items: [
                  { text: "Spring Boot 概述与版本", link: "/docs/Backend/Java/Frame/SpringBoot/v4/Overview/index.md" },
                  { text: "项目搭建", link: "/docs/Backend/Java/Frame/SpringBoot/v4/CreateProject/index.md" },
                  { text: "配置与 Profile", link: "/docs/Backend/Java/Frame/SpringBoot/v4/Configuration/index.md" },
                  { text: "Web 开发", link: "/docs/Backend/Java/Frame/SpringBoot/v4/Web/index.md" },
                  { text: "数据访问", link: "/docs/Backend/Java/Frame/SpringBoot/v4/DataAccess/index.md" },
                  { text: "REST API", link: "/docs/Backend/Java/Frame/SpringBoot/v4/RestAPI/index.md" },
                  { text: "异常处理", link: "/docs/Backend/Java/Frame/SpringBoot/v4/Exception/index.md" },
                  { text: "测试", link: "/docs/Backend/Java/Frame/SpringBoot/v4/Testing/index.md" },
                  { text: "部署", link: "/docs/Backend/Java/Frame/SpringBoot/v4/Deploy/index.md" },
                  { text: "常见问题与最佳实践", link: "/docs/Backend/Java/Frame/SpringBoot/v4/FAQ/index.md" },
                ],
              },
            ],
          },
