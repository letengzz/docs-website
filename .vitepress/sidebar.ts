...
import { AI_Agent, AI_LLMApp, AI_OpenClaw, AI_PromptEngineering, AI_RAG } from "./AI";
  ...
  "/docs/Backend": [
    {
      text: "后端",
      collapsed: true,
      items: [...DotNet, ...Go, ...Java, ...MessageQueue, ...Microservices, ...SpringCloud, ...DesignPatterns, ...NetworkProgramming, ...Python],
    },
  ],
  "/docs/DB": [
    {
  ...
  "/docs/AI": [
    {
      text: "AI",
      collapsed: true,
      items: [...AI_LLMApp, ...AI_RAG, ...AI_OpenClaw, ...AI_PromptEngineering, ...AI_Agent],
    },
  ],
  "/docs/Tools": [
    {
